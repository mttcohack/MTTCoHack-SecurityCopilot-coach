...
param VnetName string = 'Hack-vnet-${team}' 

param HackVmName string = 'hack-vm-${team}'
param HackVmPipName string = 'hack-vm-pip-${team}' 
param HackVmNicName string = 'hack-vm-nic-${team}' 
param HackVmNsgName string = 'hack-vm-nsg-${team}'
...
param DcVmNicName string = 'dc-vm-nic-${team}' 
